      ...
      <div className="container">
        <div className="row">
          <div className="login col-md-4 col-sm-12">
            ...
            <div>
              <div className="login-img"><img style={{ width: '100%' }} src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPbAZaucd7UhbAi1ngthd8Ckn7zt3NSxYAWdgfWqFBAg76Hh1Q'} /></div>
